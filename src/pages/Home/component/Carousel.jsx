...
export default function CarouselLayout() {
  ...
  return (
    <Swiper
      ...
      modules={[Navigation]}
      className='mySwiper h-[662px] md:mx-2 md:rounded-md md:h-[500px]'
    >
      {data &&
        data.data.items.map((item) => {
          return (
            ...
            >
              ...
              <div className='flex    absolute bottom-12 px-14  h-2/3 w-3/6 z-50 lg:w-4/6  md:bottom-2 mb:left-0 md:w-full md:px-8 md:h-[80%] '>
                <Image
                  resizeLayout={!widthScreen}
                  movie={item}
                ...
                />
                <div
                  className='w-[60%] px-2 md:w-full md:h-full
